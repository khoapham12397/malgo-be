...
const submitTokenScheduler = cron.schedule("*/1 * * * * *",scheduleToken, scheduleTokenOptions);
const submitSubmissionScheduler = cron.schedule("*/1 * * * * *",scheduleSubmission, scheduleSubmissionOptions);
